...
walletController.listenETHTransactions();

const Web3 = require('web3')
const web3 = new Web3(process.env.INFURA_WS_URL) // Replace this with a websocket connection to your alchemy node to monitor mainnet
