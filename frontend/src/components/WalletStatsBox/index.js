    ...
    datasets: [
        {
            ...
            backgroundColor: (context) => {
                ...
                gradient.addColorStop(1, "rgba(254, 251, 118, 0.25)");
                return gradient;
            },
            fill: true,
            data: result.data,
...
function TradingPerDayBox() {
    const [selectedItem, setSelectedItem] = useState(0);
    const classes = useStyles();

    return (
        <div className='mt-16 secondary-background p-16 w-full rounded-8'>
            <div className='block sm:flex justify-between items-center'>
                <div>
                    <p className='text-white text-11'>Monthly P/L</p>
                    <div className='flex item-center'>
                        <p className='text-sm text-gray min-w-max'>Profit & Loss</p>
                        <div className={clsx(classes.upStateBox, 'flex items-center px-4 py-1 rounded-full ml-3')}>
            ...
            <div className='flex items-center mt-16 flex-col md:flex-row'>
                <div className='md:block flex mb-12 md:mb-0'>
                    <div className={clsx(classes.selectedBox, 'py-4 sm:py-8 flex flex-col items-center w-60 xs:w-84 rounded-8 h-full md:h-auto')}>
...
export default React.memo(TradingPerDayBox);
